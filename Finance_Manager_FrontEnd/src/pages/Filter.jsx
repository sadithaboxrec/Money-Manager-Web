                ...
                <div className="card p-4 mb-4">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        ...
                        <div className="sm:col-span-1 md:col-span-1 flex items-end">
                            ...
                            <button onClick={handleSearch} className="ml-2 mb-1 p-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded flex items-center justify-center cursor-pointer">
                                <Search size={20} />
                            </button>
                        </div>
                    </form>
